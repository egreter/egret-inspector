    ...
    var r = (function (t) {
      ...
      function e(e) {
        ...
        this.move = function (t) {
          ...
          if (r.monitorY) {
            r.el.css({ transform: 'translateY(' + e + 'px)' });
          } else {
            r.el.css({ transform: 'translateX(' + i + 'px)' });
          }
        };
        this.end = function (t) {
          r.isMouseDown = false;
  ...
  (function (t) {
    var e = (function (t) {
      ...
      e.prototype.updateIcon = function () {
        this.icon =
          this.hasChildren == false ? '&nbsp;' : this.show ? '-' : '+';
      };
      e.prototype.recover = function () {
        if (
          this.show &&
          this.hasChildren &&
          (this.children != this._children || this.props != this._props)
        ) {
          this.children = null;
          this.props = null;
          this.showChildren();
      ...
      e.parseRawProps = function (t, r, i, n) {
        ...
        if (n === void 0) {
          n = { showPrivate: true, showMethods: false };
        }
        if (r < 0) return;
        ...
        for (var o in t) {
          if (
            n.showPrivate === false &&
            (String(o).indexOf('_') == 0 || String(o).indexOf('$') == 0)
          ) {
            continue;
          }
          var a = new e();
      ...
      e.clone = function (t, r, i) {
        ...
        if (t._children.length > 0)
          i._children = t._children.map(function (t) {
  ...
  (function (t) {
    var e = (function () {
      ...
      t.prototype.post = function (t, e, r) {
        ...
        var n = { id: i, data: t, key: this.key };
        this._doPost(n);
        return this;
      };
  ...
  (function (e) {
    ...
    var u = (function () {
      ...
      e.checkContainer = function (r, i, n) {
        ...
        if (r.scrollRect) {
          if (
            i < r.scrollRect.x ||
            n < r.scrollRect.y ||
            i > r.scrollRect.x + r.scrollRect.width ||
            n > r.scrollRect.y + r.scrollRect.height
          ) {
            return null;
          }
        } else if (r.mask) {
          if (
            r.mask.x > i ||
            i > r.mask.x + r.mask.width ||
            r.mask.y > n ||
            n > r.mask.y + r.mask.height
          ) {
            return null;
          }
        }
      ...
      e.find = function (t, r) {
        if (
          r.hashCode == t ||
          (r.name &&
            r.name.toLowerCase().indexOf(t.toString().toLowerCase()) >= 0)
        )
          return [r];
    ...
    var d = (function () {
      ...
      e.prototype.draw = function (e, r, i) {
        ...
        var f = 0,
          v = 0;
        var g = { x: 0, y: 0, width: r.width, height: r.height };
        var y = i ? n : h;
        var m = i ? s : l;
    ...
    var p = (function (e) {
      ...
      r.prototype.draw = function (e, r, i) {
        ...
        var p = 0,
          f = 0;
        var v = i
          ? { r: 79 / 255, g: 169 / 255, b: 144 / 255, a: 0.2 }
          : { r: 79 / 255, g: 96 / 255, b: 169 / 255, a: 0.2 };
        var g = {
          x: 0,
          y: 0,
          w: r.width,
      ...
      r.prototype.renderGraphics = function (t) {
        ...
        e.uniformMatrix3fv(
          r.translationMatrix,
          false,
          this.glRenderer['worldTransform'].toArray(true)
        );
        e.uniform2f(
          r.projectionVector,
          this.glRenderer['projectionX'],
          -this.glRenderer['projectionY']
        );
        ...
        e.drawElements(
          e.TRIANGLE_STRIP,
          this.graphicsIndices.length,
          e.UNSIGNED_SHORT,
          0
        );
        this.glRenderer['shaderManager'].activateShader(
          this.glRenderer['shaderManager'].defaultShader
        );
      };
      r.prototype.updateGraphics = function (t) {
        ...
        e.bufferData(
          e.ARRAY_BUFFER,
          new Float32Array(this.graphicsPoints),
          e.STATIC_DRAW
        );
        e.bindBuffer(e.ELEMENT_ARRAY_BUFFER, this.graphicsIndexBuffer);
        e.bufferData(
          e.ELEMENT_ARRAY_BUFFER,
          new Uint16Array(this.graphicsIndices),
          e.STATIC_DRAW
        );
      };
    ...
    var g = (function (r) {
      ...
      i.prototype.attach = function (r) {
        ...
        this.textureCtx.font =
          12 * d + 'px Consolas,Courier New, Courier, monospace';
      ...
      i.prototype.getLastSelected = function () {
        return this.lastSelected && this.lastSelected.stage
          ? this.lastSelected
          : undefined;
      };
  ...
  (function (e) {
    ...
    var i = (function (t) {
      ...
      e.prototype.detach = function () {
        ...
        this.stage.removeListener(
          lark.TouchEvent.TOUCH_BEGIN,
          this.touchHandler,
          this,
          true
        );
        this.stage.removeListener(
          lark.TouchEvent.TOUCH_END,
          this.touchHandler,
          this,
          true
        );
        this.stage.removeListener(
          lark.TouchEvent.TOUCH_MOVE,
          this.touchHandler,
          this,
          true
        );
        this.stage.removeListener(
          lark.Event.ENTER_FRAME,
    ...
    var s = (function (t) {
      ...
      e.prototype.showMetrics = function (t) {
        ...
        var h = { x: i.x - 0.5, y: i.y - 0.5 };
        s.moveTo(h.x, h.y);
        s.lineStyle(1, 15987133, 0.9);
        s.beginFill(15987133, 0.7);
        s.lineTo(h.x + o, h.y);
      ...
      e.prototype.drawTarget = function (t, e) {
        ...
        u.moveTo(s.x - 0.5, s.y - 0.5);
        u.lineStyle(1, c[0], 0.5);
        u.beginFill(c[0], 0.2);
        u.lineTo(a.x - 0.5, a.y - 0.5);
        u.lineTo(h.x - 0.5, h.y - 0.5);
        u.lineTo(l.x - 0.5, l.y - 0.5);
        u.lineTo(s.x - 0.5, s.y - 0.5);
        u.endFill();
      };
      return e;
    })(lark.Sprite);
...
(function (t) {
  ...
  (function (e) {
    ...
    var i = (function (i) {
      ...
      s.prototype.highlightType = function (t, e) {
        if (e === void 0) {
          e = true;
        }
        e = !!e;
        this.mask.highlight[t] = e;
        if (!e) this.mask.setTarget(null, t);
      ...
      s.prototype.confirmListeners = function () {
        if (
          this.mask.highlight[e.TartgetType.active] ||
          this.mask.highlight[e.TartgetType.hover] ||
          this._preventTouch
        )
          this.addListeners();
      ...
      s.prototype.touchHandler = function (r) {
        ...
        var i = r.target;
        var s = n(this.stage, r.stageX, r.stageY);
        if (s) i = s;
...
(function (egret) {
  ...
  (function (devtool) {
    var rootDiv;
    var MainEntrace = (function () {
      function MainEntrace() {
        var t = this;
        this.tree = null;
        ...
        this.search = function (e, r) {
          ...
          var s = devtool.DisplayObjectLocator.find(
            i,
      ...
      MainEntrace.prototype.init = function () {
        var _this = this;
        ...
        var port = this.port;
        isp.preventTouch(MainEntrace.preventTouch);
        port.removeAll();
        ...
        port.on('preventTouch', function (t) {
          var e = t.data;
          // console.log('[Egret调试器] 舞台接收 preventTouch:', e);
          MainEntrace.preventTouch = e;
          window.__egretInspectorPreventTouch = e;
        ...
        port.on('initOptions', function (t) {
          ...
          MainEntrace.preventTouch = t.preventTouch;
        ...
        port.on('expand', function (msg, callback) {
          ...
          var tree = devtool.TreeNode.parseRawProps(
            value,
            0,
            new devtool.TreeNode(),
            { showMethods: _this.showMethods, showPrivate: _this.showPrivate }
          );
          callback(tree);
        });
        var propIdx = 0;
      ...
      MainEntrace.prototype.destroy = function () {
        if (currentInspector) {
        ...
        MainEntrace.instance = null;
        window.__egretInspectorInstance = null;
      };
      MainEntrace.prototype.refresh = function () {
        if (!this.port) {
          // console.warn('[Egret调试器] Port未初始化，无法刷新');
          return;
        }
        devtool.TreeNode.clear();
        var t = currentStage;
        this.tree = devtool.TreeNode.parseNode(
          t,
          new devtool.TreeNode(),
          true,
          2
      ...
      MainEntrace.prototype.transTreeToPanel = function (t) {
        if (t === void 0) {
          t = this.tree;
        }
        if (!this.port) {
          // console.warn('[Egret调试器] Port未初始化，无法发送树数据');
          return;
        }
        this.port.post({ name: 'updateTree', data: this.tree });
      };
      MainEntrace.prototype.showItInTree = function (t, e) {
        if (e === void 0) {
          e = null;
        }
      ...
      MainEntrace.prototype.transGameSelection = function (t, e, r) {
        if (r === void 0) {
          r = null;
        }
        if (!this.port) {
          // console.warn('[Egret调试器] Port未初始化，无法发送选择数据');
          return;
        }
        this.port.post({
          name: 'updateSelection',
          data: { hash: t, props: e, treeChange: r },
        });
      };
      MainEntrace.prototype.showTreeSelection = function (t, e) {
        if (e === void 0) {
          e = false;
        }
        var r = devtool.TreeNode.getByHash(t);
        r &&
          currentInspector.show(
            r.raw,
            e ? devtool.TartgetType.hover : devtool.TartgetType.active
          );
      };
      MainEntrace.prototype.preventTouch = function (t) {
        window.__egretInspectorPreventTouch = t;
        currentInspector.preventTouch(t);
      };
      if (window.__egretInspectorPreventTouch === undefined) {
        window.__egretInspectorPreventTouch = false;
      }
      MainEntrace.preventTouch = window.__egretInspectorPreventTouch;
      MainEntrace.instance = null;
      return MainEntrace;
    })();
    devtool.MainEntrace = MainEntrace;
    function start() {
      // 强制单例，销毁旧实例
      if (MainEntrace.instance) {
        // console.log('[Egret调试器] 检测到旧的MainEntrace实例，正在销毁...');
        MainEntrace.instance.destroy();
      }

      var t = function (t) {
        t.post({ name: 'init', from: 'stage', href: location.href });
        MainEntrace.instance.port = t;
        MainEntrace.instance.init();
        t.post({ name: 'ready' });
        // Port 初始化完成后再执行首次刷新
        window.setTimeout(function () {
          MainEntrace.instance.refresh();
        }, 200);
      };
      var e = function () {
        MainEntrace.instance = new MainEntrace();
        window.__egretInspectorInstance = MainEntrace.instance; // 暴露实例
        if (stagePort) {
          t(stagePort);
        } else {
      ...
      if (n || s) {
        if (currentInspector) {
          // console.log('[Egret调试器] 检测到旧的Inspector实例，正在销毁...');
          currentInspector.destroy();
          currentInspector = null;
        }
    ...
    function refresh() {
      ...
      if (MainEntrace.instance && MainEntrace.instance.refresh) {
        MainEntrace.instance.refresh();

      } else {
        // console.warn('[Egret调试器] MainEntrace实例不可用，无法刷新');
      }
    }
    devtool.refresh = refresh;
    var stagePort = null;
    function ping() {
      var t = devtool.PortFactory.getStagePortClass();
      stagePort = new t(location.host, function () {
        stagePort.post({ name: 'isDevToolOpen' }, null, function (t) {
          if (t) {
            start();
          }
        });
