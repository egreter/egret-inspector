	...
	(function(e) {
		var t = function(e) {
			...
			t.prototype.recover = function() {
				if (this.show && this.hasChildren && (this.children != this._children || this.props !=
						this._props)) {
					this.children = null;
					this.props = null;
					this.showChildren()
			...
			t.parseRawProps = function(e, n, r, i) {
				...
				var o = [];
				for (var s in e) {
					if (i.showPrivate === false && (String(s).indexOf("_") == 0 || String(s).indexOf(
							"$") == 0)) {
						continue
					}
					var a = new t;
		...
		var t = function(t) {
			...
			Object.defineProperty(n.prototype, "highlightHover", {
				set: function(e) {
					...
					if (e != this.chkHighlightHover.is("checked")) this.chkHighlightHover.attr(
						"checked", e);
			...
			Object.defineProperty(n.prototype, "highlightClick", {
				set: function(e) {
					...
					if (e != this.chkHighlightClick.is(":checked")) this.chkHighlightClick.attr(
						"checked", e);
			...
			n.prototype.init = function() {
				...
				this.highlightClick = (window.localStorage.getItem("highlightClick") || "true") ==
					"true";
				this.highlightHover = (window.localStorage.getItem("highlightHover") || "false") ==
					"true";
			...
			n.prototype.bindNode = function(t, n) {
				...
				var i = this;
				var o = i.itemTmpl.replace("{name}", t.name).replace("{memberName}", t.memberName)
					.replace("{icon}", t.icon);
				var s = $(o);
...
(function(e) {
	var t;
	(function(e) {
		var t = ["x", "y", "width", "height", "measuredWidth", "measuredHeight", "layoutBoundsWidth",
			"layoutBoundsHeight", "preferredWidth", "preferredHeight", "left", "right", "top", "bottom",
			"percentWidth", "percentHeight", "verticalCenter", "horizontalCenter", "explicitWidth",
			"explicitHeight", "includeInLayout", "preferredX", "preferredY", "layoutBoundsX",
			"layoutBoundsY", "maxWidth", "minWidth", "skin", "skinName", "source", "content", "maxHeight",
			"minHeight", "visible", "alpha", "parent"
		];
		var n = function(e) {
			__extends(n, e);
			...
			function n() {
				...
				this.filterProps = function() {
					...
					if (!e) {
						t.container.find(".property.searchResult").removeClass(
							"searchResult searchCurrent");
						t.lastQuery = e;
						return
					}
					var n = null;
			...
			Object.defineProperty(n.prototype, "showMethods", {
				set: function(e) {
					this._showMethods = e;
					if (e != this.chkShowMethods.is(":checked")) this.chkShowMethods.attr(
						"checked", e);
			...
			Object.defineProperty(n.prototype, "showPrivate", {
				set: function(e) {
					this._showPrivate = e;
					if (e != this.chkShowPrivate.is(":checked")) this.chkShowPrivate.attr(
						"checked", e);
			...
			n.prototype._initPropElement = function(e) {
				var t = this.itemTmpl.replace("{icon}", e.expandable ? "+" : " ").replace("{name}", e
					.name);
				var n = $(t);
		...
		var t = function(t) {
			...
			function n() {
				...
				this.changeLayout = function(e) {
					...
					$("#props").outerHeight(o - $("#searchProp").outerHeight() - $("#propHeader")
						.outerHeight())
				}
			}
			n.prototype.init = function() {
